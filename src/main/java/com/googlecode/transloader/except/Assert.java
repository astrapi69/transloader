...
public final class Assert
{
	 ...
	 * @throws IllegalArgumentException
	 *             if either <code>parameter1</code> or <code>parameter2</code> is <code>null</code>
	 */
	 ...
	 *            the second parameter to check
	 * @param parameter3
	 *            the third parameter to check
	 * @throws IllegalArgumentException
	 *             if either <code>parameter1</code>, <code>parameter2</code> or
	 ...
	 *            the third parameter to check
	 * @param parameter4
	 *            the fourth parameter to check
	 * @throws IllegalArgumentException
	 *             if either <code>parameter1</code>, <code>parameter2</code>,
	 *             <code>parameter3</code> or <code>parameter4</code> is <code>null</code>
	 */
	public static void areNotNull(Object parameter1, Object parameter2, Object parameter3,
		Object parameter4)
	{
	 ...
	 *            the fourth parameter to check
	 * @param parameter5
	 *            the fifth parameter to check
	 * @throws IllegalArgumentException
	 *             if either <code>parameter1</code>, <code>parameter2</code>,
	 *             <code>parameter3</code>, <code>parameter4</code> or <code>parameter5</code> is
	 *             <code>null</code>
	 */
	public static void areNotNull(Object parameter1, Object parameter2, Object parameter3,
	 ...
	 * @throws IllegalArgumentException
	 *             if any elements of <code>parameters</code> are <code>null</code>
	 */
	 ...
	 *            the parameter to check
	 * @return the given <code>parameter</code> (if an <code>Exception</code> was not already thrown
	 *         because it was not an array)
	 * @throws IllegalArgumentException
	 *             if <code>parameter</code> is not an array
	 */
	public static Object isArray(Object parameter)
	{
		if (!isNotNull(parameter).getClass().isArray())
			throw new IllegalArgumentException(
				"Expecting an array but received '" + parameter + "'.");
		return parameter;
	}
	 ...
	 * @param actual
	 *            the actual number to compare
	 * @param name
	 *            the name of the number being compared
	 * @throws IllegalArgumentException
	...
	public static void isEqualTo(long expected, long actual, String name)
	{
		...
		if (!(expected == actual))
			throw new IllegalArgumentException(
				"Expecting " + name + " equal to " + expected + " but received " + actual + ".");
	}
	...
	public static void contains(Object element, Object[] array)
	{
		...
		if (!(list.contains(element)))
			throw new IllegalArgumentException(
				"Expecting one of " + list + " but received " + element + ".");
	}
