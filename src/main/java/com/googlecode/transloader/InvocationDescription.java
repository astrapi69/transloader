...
public final class InvocationDescription
{
	 ...
	 *
	 * @param methodName
	 *            the name of a zero-parameter method
	 */
	 ...
	 *
	 * @param methodName
	 *            the name of a single-parameter method
	 * @param parameter
	 *            a parameter whose concrete implementation <code>Class</code> has the same name as
	 *            its type declared in the targeted method (therefore cannot be <code>null</code>)
	 */
	 ...
	 *
	 * @param methodName
	 *            the name of a multi-parameter method
	 * @param parameters
	 *            some parameters whose concrete implementation <code>Class</code>es have the same
	 *            names as their types declared in the targeted method (therefore cannot contain
	 *            <code>null</code>s)
	 */
	...
	/**
	 * Constructs an <code>InvocationDescription</code> with the given method name, parameter type
	 * and parameter.
	 *
	 * @param methodName
	 *            the name of a single-parameter method
	 * @param parameterType
	 *            a <code>Class</code> whose name is the same as the parameter type declared in the
	 *            method
	 * @param parameter
	 *            the parameter to the method invocation (can be <code>null</code>)
	 */
	 ...
	 *            the name of the parameter type declared in the method
	 * @param parameter
	 *            the parameter to the method invocation (can be <code>null</code>)
	 */
	public InvocationDescription(String methodName, String parameterTypeName, Object parameter)
	{
		// TODO test InvocationDescription(String methodName, String parameterTypeName, Object
		// parameter)
		this(methodName, new String[] { parameterTypeName }, new Object[] { parameter });
	}

	/**
	 * Constructs an <code>InvocationDescription</code> with the given method name, parameter types
	 * and parameters.
	 *
	 * @param methodName
	 *            the name of a multi-parameter method
	 * @param parameterTypes
	 *            some <code>Class</code>es whose names are the same as the parameter types declared
	 *            in the targeted method
	 * @param parameters
	 *            the parameters to the method invocation (cannot be but can <i>contain</i>
	 *            <code>null</code>)
	 */
	 ...
	 *            the names of the parameter types declared in the method (cannot be or contain
	 *            <code>null</code>)
	 * @param parameters
	 *            the parameters to the method invocation (cannot be but can <i>contain</i>
	 *            <code>null</code>)
	 */
	public InvocationDescription(String methodName, String[] parameterTypeNames,
		Object[] parameters)
	{
	...
	/**
	 * Constructs an <code>InvocationDescription</code> with the given {@link Method} and
	 * parameters.
	 *
	 * @param method
	 *            the <code>Method</code> to invoke
	 * @param parameters
	 *            the parameters to the method invocation (can actually be <code>null</code>)
	 */
	...
	public static Method getMethod(String name, Class[] paramTypes, Class owner)
